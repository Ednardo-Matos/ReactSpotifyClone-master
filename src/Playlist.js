...
/*reggae*/
import wandinho from './musicas/sorri.mp3';
import wandinho2 from './musicas/exagerado.mp3';
...
export default function Playlist(){
        ...
        const playlists = [
            {id: 1, nome: 'Rock', capa: 'rock.jpeg', musicas:[{id: 1, nome: "Nando Reis - Livre", aquivo: "nandoresis.mp3"},{}]},
            ...
            {id: 5, nome: 'Reggae', capa: 'reggae.jpeg', musicas:[{id: 1, nome: "Wandinho - exagerado", aquivo: "exagerado.mp3"},{}]},
